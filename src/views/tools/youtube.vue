<template>
  <div>
    <section class="hero">
      <div class="hero-body">
        <div class="container">
          <h1 class="title">YouTube Dev Utilities</h1>
          <p>
            Here you'll find a collection of utilities you might find useful
            when developing websites that use YouTube's various API's.
          </p>
          <hr />
        </div>
      </div>
    ...
    <section class="utilities">
      <div class="container">
        <div class="columns is-multiline">
          ...
          <div class="column is-6">
            <div class="tool-card">
              <h2 class="subtitle">Create Playlist with Video IDs</h2>
              <p>
                Create a simple link with the href source matching the example
                below. Replace the video ID array with your own array of ID's.
              </p>
              <br />
              <code>
                http://www.youtube.com/watch_videos?video_ids=[array, of, video,
                IDs]
              </code>
              <br />
            </div>
